...
FUND_CODE = "63YTW"  # 統一投信內部代碼，對應 00403A
...
def fetch_holdings() -> tuple[str, list[dict]]:
    """從 ezmoney 抓取 00403A 持股，只回傳股票 (AssetCode == 'ST')。"""
    ...
    raise RuntimeError(f"連續 3 次抓取 00403A 失敗，最後錯誤：{last_exc}")
...
def main() -> None:
    print("正在抓取 ezmoney 00403A 持股資料…")
