...
HISTORY_FILE = DATA_DIR / "history_00403A.json"
LATEST_FILE = DATA_DIR / "latest_00403A.json"

URL = "https://www.moneydj.com/etf/x/basic/basic0007B.xdjhtm?etfid=00403A.TW"
HEADERS = {
    "User-Agent": (
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="ETF 00403A 持股追蹤器")
    ...
    if args.cmd == "fetch" or args.cmd is None:
        print("正在抓取 MoneyDJ 00403A 持股資料…")
